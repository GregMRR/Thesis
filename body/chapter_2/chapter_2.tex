...
\begin{center}
    ...
    \node at (8,\ytwo) {\begin{math}\text{-}\frac{i}{2}\lambda_{1234}\left(\dfrac{1}{\G_1^*\F_1^{}}+\dfrac{1}{\G_2^*\F_2^{}}-\dfrac{1}{\G_3^{}\F_3^{}}
        -\dfrac{1}{\G_4^{}\F_4^{}}\right)2\pi\delta(\delomegatt^{12}_{34})\delta^{12}_{34}\end{math}};
    ...
    \node at (6,\y) {\(\text{-}\sum_{k}\limits\dfrac{\lambda_{123k}\lambda_{k456}}{F_k}2\pi\delta(\delomegatt^{124}_{356})\delta^{12}_{3k}\delta^{k4}_{56}\)};
...
There are four  one loop diagrams contributing to the four point function. Three of them, in figure \ref{fig:quarticoneloop}, are composed from two quartic vertices and
