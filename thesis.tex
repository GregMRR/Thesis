...
\usepackage[top=2.5 cm, bottom=2 cm, left=2 cm,right=2 cm]{geometry}

%to manage itemize lists
\usepackage{enumitem}
\setlist[itemize,1]{label=\textbf{\dagger}}
...
\titleformat{\subsection}{\bfseries\Large}{\upshape\thesubsection}{6pt}{#1}
%\itshape for italics
